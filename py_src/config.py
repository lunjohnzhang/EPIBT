...
class WarehouseConfig:
    ...
    # Simulation
    # Shared by PIBT, PIBT_R, FCFS, and RHCR
    ...
    task_waiting_time: int = 5
    workstation_waiting_time: int = 1
    task_change_time: int = 100
    task_gaussian_sigma: float = 0.01
    time_dist: bool = True
    time_sigma: int = 1000
    manually_clean_memory: bool = True
    ...
    algo_config_path: str = None  # For LORR24
    rand_mode: str = "fixed"  # For LORR24
    lns_n_thread: int = 4  # For WPPL
    ...
    iter_update_init_obs: str = None

    # Lifelong SMART
    sim_duration: int = 1800 * 10
    robot_velocity: float = 200.0
    look_ahead_dist: int = 5
    planner: str = "RHCR"  # ["PBS", "RHCR"]
    container: bool = True

    pibt_window_size: int = 1
    pibt_max_replan: int = 0

    # EPIBT
    epibt_map_type: str = "RANDOM"
    epibt_planner_type: str = "EPIBT"
    epibt_scheduler_type: str = "CONST"
    epibt_gg_type: str = "DISABLE"